document.addEventListener('DOMContentLoaded', function() {
    ...
    const eventColorIndicator = document.getElementById('event-color-indicator');
    ...
    function updateCurrentDateDisplay() {
        ...
        // Format day number: "15"
        currentDayDisplay.textContent = today.getDate();
        ...
        currentDateDisplay.textContent = `${year}. ${monthName}, ${dayName}`;
    }
    ...
    function updateUpcomingEvents() {
        ...
        displayEvents.forEach(event => {
            ...
            eventElement.style.borderLeftColor = getEventColor(event.color);
    ...
    function getEventColor(colorClass) {
        switch(colorClass) {
    ...
    function showEventDetails(event) {
        ...
        const detailsTime = document.querySelector('.event-time-text');
        const detailsTimeContainer = document.querySelector('.event-details-time');
        const detailsDescription = document.querySelector('.event-details-description');
        const descriptionBox = document.querySelector('.event-description-box');
        
        // Set event color indicator
        eventColorIndicator.style.backgroundColor = getEventColor(event.color);
        ...
        if (event.startTime) {
            ...
            detailsTimeContainer.classList.remove('d-none');
        } else {
            detailsTimeContainer.classList.add('d-none');
        }
